...
angular.module('bahmni.common.displaycontrol.custom')
        ...
        var link = function ($scope, element) {
            ...
            var getAllDrugOrdersFor = function (patientUuid, conceptSetToBeIncluded, conceptSetToBeExcluded, isActive, patientProgramUuid, $q) {
                var deferred = $q.defer();
                 patientProgramUuid =87653;
             console.log(patientProgramUuid);
    ...
    }]).directive('testTool', ['$http','$translate', 'spinner','$q', 'appService', 'messagingService', 'observationsService',
    function ($http, $translate, spinner, $q, appService, messagingService, observationsService) {
 ...
 $scope.article = "Bahmni printout test";  
            ...
            $scope.contentUrl = appService.configBaseUrl() + "/customDisplayControl/views/testTool.html";
